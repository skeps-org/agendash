const confirmRequeue = Vue.component("confirm-requeue", {
  ...
  render: function () {with(this){return _c('div',{staticClass:"modal fade",attrs:{"id":"modalRequeueSure","tabindex":"-1","role":"dialog","aria-labelledby":"exampleModalLabel","aria-hidden":"true"}},[_c('div',{staticClass:"modal-dialog",attrs:{"role":"document"}},[_c('div',{staticClass:"modal-content"},[_m(0),_c('div',{staticClass:"modal-body"},[_c('p',[_v("ID: "+_s(job.job._id))]),_c('p',[_v("Name: "+_s(job.job.name))])]),_c('div',{staticClass:"modal-footer"},[_c('button',{staticClass:"btn btn-info",attrs:{"type":"button","data-dismiss":"modal"},on:{"click":function($event){return RequeueOne(job.job._id)}}},[_v("Requeue Job")]),_c('button',{staticClass:"btn btn-secondary",attrs:{"type":"button","data-dismiss":"modal"}},[_v("Cancel")])])])])])}},
  staticRenderFns: [
